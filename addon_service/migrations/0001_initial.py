    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(editable=False)),
                ('modified', models.DateTimeField()),
                ('credentials', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='external_accounts', to='addon_service.externalcredentials')),
                ('credentials_issuer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='external_accounts', to='addon_service.credentialsissuer')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='external_accounts', to='addon_service.userreference')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='authorized_storage_accounts', to='addon_service.externalaccount'),
        ),
        migrations.AddField(
            model_name='authorizedstorageaccount',
